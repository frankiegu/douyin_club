...
function registerUser(callback) {
    ...
    var dat = {
        'url': 'http://'+ window.location.hostname + ':8081/user',
        'method': 'POST',
...
function signinUser(callback) {
    ...
    var dat = {
        'url': 'http://'+ window.location.hostname + ':8081/user/' + username,
        'method': 'POST',
        'req_body': JSON.stringify(reqBody)
    };
...
function getUserId(callback) {
    var dat = {
        'url': 'http://' + window.location.hostname + ':8081/user/' + uname,
        'method': 'GET'
    };
...
function createVideo(vname, callback) {
    ...
    var dat = {
        'url': 'http://' + window.location.hostname + ':8081/user/' + uname + '/videos',
        'method': 'POST',
        'req_body': JSON.stringify(reqBody)
    };
...
function deleteVideo(vid, callback) {
    var dat = {
        'url': 'http://' + window.location.hostname + ':8081/user/' + uname + '/videos/' + vid,
        'method': 'DELETE',
        'req_body': ''
    };
...
function postComment(vid, content, callback) {
    ...
    var dat = {
        'url': 'http://' + window.location.hostname + ':8081/videos/' + vid + '/comments',
        'method': 'POST',
        'req_body': JSON.stringify(reqBody)
    };
